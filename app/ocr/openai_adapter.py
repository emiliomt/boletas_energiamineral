...
_SYSTEM_PROMPT = (
    ...
    "Si el documento NO imprime la etiqueta \"Folio\", entonces crea una entrada \"Folio\" usando el número de serie rojo estampado del formato "
    "(5–6 dígitos; prefiere números de 6 dígitos con ceros a la izquierda como \"003612\" sobre números manuscritos de 5 dígitos). "
    "En ese caso (sin etiqueta Folio) devuelve SOLO los dígitos (sin espacios/guiones). "
    "Si SÍ existe la etiqueta \"Folio\" impresa, entonces copia el valor EXACTAMENTE como aparece (incluyendo prefijos como \"B-8001\"). "
